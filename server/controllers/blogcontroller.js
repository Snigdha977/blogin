...
export const getBlogs = async (req, res) => {
  try {
    ...
    console.log(`Found ${blogs.length} blogs for query:`, query)
...
export const getMyBlogs = async (req, res) => {
  try {
    ...
    console.log(`Found ${blogs.length} blogs for user ${req.user._id}`)
...
export const getBlogBySlug = async (req, res) => {
  try {
    ...
    console.log("Found blog:", blog ? `${blog.title} (${blog.status})` : "Not found")
...
export const createBlog = async (req, res) => {
  try {
    ...
    console.log("- Author:", blog.author._id)

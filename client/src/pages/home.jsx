...
const Home = () => {
  ...
  const { data, isLoading, error, refetch } = useQuery(
    ...
    async () => {
      ...
      console.log("Home page blogs response:", response.data)
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {/* {process.env.NODE_ENV === "development" && (
        <div className="bg-blue-50 border-b border-blue-200 p-2">
          <div className="max-w-7xl mx-auto text-xs text-blue-800">
            <strong>Home Debug:</strong> Found {data?.data?.blogs?.length || 0} blogs | Loading: {isLoading.toString()}{" "}
            | Error: {error ? error.message : "None"} | Filters: {JSON.stringify(filters)}
          </div>
        </div>
      )} */}
      ...
      <section className="bg-gradient-to-br from-primary/10 via-white to-purple-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              Join thousands of writers sharing their knowledge, experiences, and insights. Create, publish, and grow
              your audience on BlogSpace.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}

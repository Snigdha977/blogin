...
const AdminDashboard = () => {
  ...
  const {
    ...
    retryDelay: 1000,
    onSuccess: (data) => {
      console.log("📊 Stats query success:", data.data)
    },
    onError: (error) => {
  ...
  const {
    ...
    retry: 2,
    onSuccess: (data) => {
      console.log("👥 Users query success:", data.data)
    },
    onError: (error) => {
  ...
  const {
    ...
    retry: 2,
    onSuccess: (data) => {
      console.log("📝 Blogs query success:", data.data)
    },
    onError: (error) => {
  ...
  const {
    ...
    () => adminAPI.getDetailedStats(detailedStatsModal.type, { limit: 50 }),
    {
      ...
      onSuccess: (data) => {
        console.log(`📊 Detailed ${detailedStatsModal.type} stats:`, data.data)
      },
    },
  )
  ...
  const handleStatsCardClick = (type, title) => {
    console.log(`📊 Opening detailed stats for: ${type}`)
